...
public class AdmaruTest extends IntegrationTest {
    ...
    public void openrtb2AuctionShouldRespondWithBidsFromAdmaru() throws IOException, JSONException {
        // given
        WIRE_MOCK_RULE.stubFor(post(urlPathEqualTo("/admaru-exchange"))
        ...
        // then
        assertJsonEquals("openrtb2/admaru/test-auction-admaru-response.json", response,
                singletonList("admaru"));
    }
}
